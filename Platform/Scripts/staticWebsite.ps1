# Enabling the Static Website option for a Storage Account isn't exposed as a configurable item within Bicep or ARM Templates. We are using the Azure CLI commands below to enable this setting.
